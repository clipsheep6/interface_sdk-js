...
export class ArcDotIndicator {
   ...
   *
   * @param { Optional<ArcDirection> } direction - the direction of arc indicator.
   * @default ArcDirection.SIX_CLOCK_DIRECTION
   ...
   *
   * @param { Optional<ResourceColor> } color - the indicator item color.
   * @default #A9FFFFFF
   * @returns { ArcDotIndicator }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
   ...
   *
   * @param { Optional<ResourceColor> } color - the indicator item when selected.
   * @default #FF5EA1FF
   * @returns { ArcDotIndicator }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
   ...
   *
   * @param { Optional<ResourceColor> } color - the background color.
   * @default #FF404040
   * @returns { ArcDotIndicator }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
...
declare class ArcSwiperAttribute extends CommonMethod<ArcSwiperAttribute> {
   ...
   *
   * @param { Optional<number> } value - The index value of the subcomponents to be displayed.
   * @default 0
   * @returns { ArcSwiperAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
   ...
   *
   * @param { Optional<ArcDotIndicator | boolean> } style - The style information of the indicator or whether to display the indicator.
   * @default true
   * @returns { ArcSwiperAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
   ...
   *
   * @param { Optional<number> } duration - Duration of animation.
   * @default 400
   * @returns { ArcSwiperAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
   ...
   *
   * @param { Optional<boolean> } isVertical - The value indicates whether to slide vertically.
   * @default false
   * @returns { ArcSwiperAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
   ...
   *
   * @param { Optional<boolean> } isDisable - The value indicates whether the sliding function is enabled.
   * @default false
   * @returns { ArcSwiperAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Circle
   * @crossplatform
