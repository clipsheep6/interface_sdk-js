...
declare namespace notificationManager {
   ...
   * @throws { BusinessError } 1600015 - Notification repeat create or end.
   * @throws { BusinessError } 1600016 - Expired update.
   ...
   *
   * @permission ohos.permission.NOTIFICATION_CONTROLLER
   * @param { LiveViewFilter } filter - The bundle, notification key and additional information filter of the live view notification.
