 ...
 */
  ...
  interface MediaKeySession {
     ...
     * @param { MediaKeyType } mediaKeyType - Offline or online.
     ...
     * @since 11
     */
    generateMediaKeyRequest(mimeType: string, initData: Uint8Array, mediaKeyType: MediaKeyType, options?: OptionsData[]): Promise<MediaKeyRequest>;
