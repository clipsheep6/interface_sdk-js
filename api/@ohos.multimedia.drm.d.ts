...
declare namespace drm {
     ...
     * @param name Used to point a Digital Right Managements solution.
    ...
    /**
     * Provide functions and keep a decrypt module. Before calling an MediaKeySession method, we must use MediaKeySystem's
     * createMediaKeySession to get a key session instance.
     * @since 11
     * @syscap SystemCapability.Multimedia.Drm.Core
     */
    interface MediaKeySession {
         ...
         */
        generateLicenseRequest(mimeType: string, initData: Uint8Array, licenseType: number, optionalData?: OptionalData[]): Promise<LicenseRequest>;
