 ...
 * @deprecated since 9, use bundle.distributeBundle
 */
 declare namespace distributedBundle {
   ...
   * @systemapi
   * @deprecated since 9, use distributeBundle.getRemoteAbilityInfo
   */
   ...
   * @permission ohos.permission.GET_BUNDLE_INFO_PRIVILEGED
   * @systemapi
   * @deprecated since 9, use distributeBundle.getRemoteAbilityInfos
   */
