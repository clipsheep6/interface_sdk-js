...
declare namespace systemParameterV9 {
     ...
     * @throws {BusinessError} with SYSPARAM_INVALID_INPUT if type of key is not string or key is not specified.
     ...
     * @throws {BusinessError} with SYSPARAM_INVALID_INPUT if type of key is not string or key is not specified.
     * @throws {BusinessError} with SYSPARAM_INVALID_VALUE if value is invalid
     * @throws {BusinessError} with SYSPARAM_PERMISSION_DENIED if permission denied
     * @throws {BusinessError} with SYSPARAM_SYSTEM_ERROR if system internal error
     * @syscap SystemCapability.Startup.SystemInfo
     * @since 9
