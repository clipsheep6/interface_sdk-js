...
declare namespace settings {
   ...
   * @hide SystemApi
   */
  function setValue(dataAbilityHelper: DataAbilityHelper, name: string, value: object, callback: AsyncCallback<void>): void;
  function setValue(dataAbilityHelper: DataAbilityHelper, name: string, value: object): Promise<void>;
