...
interface SecSaveButtonInterface {
   ...
   *
   * @param { SecSaveButtonOptions } option - Indicates the options of the save button.
   * @returns { SecSaveButtonAttribute } Returns the attribute of the save button.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 10
   */
 ...
 * @since 10
 */
declare class SecSaveButtonAttribute extends SecCompButtonAttribute {
  /**
   * Layout direction of the icon and text.
   *
   * @param { SecSaveButtonLayoutDirection } value - Indicates the layout direction of the icon and text.
   * @returns { SecSaveButtonAttribute } Returns the attribute of the save button.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 10
   */
   ...
   *
   * @param { SecSaveButtonLayoutOrder } value - Indicates the layout order of the icon and text.
   * @returns { SecSaveButtonAttribute } Returns the attribute of the save button.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 10
   */
