...
interface Span extends CommonMethod<Span> {
  ...
  fontColor(value: Color | number | string): Span;

  fontSize(value: number | string): Span;

  fontStyle(value: FontStyle): Span;

  fontWeight(value: number | FontWeight | string): Span;

  fontFamily(value: string): Span;

  decoration(value: { type: TextDecorationType, color?: Color | number | string }): Span;
