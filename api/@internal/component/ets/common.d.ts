...
declare interface TranslateOptions {
   ...
   *
   * @type { ?(SharedTransnumber | stringitionEffectType) }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 7
   */
  /**
...
declare interface PopupOptions {
   ...
   * on State Change
   *
   * @type { ?((event: {isVisible: boolean}) => void;) }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 7
   */
  /**
...
declare class CommonMethod<T> {
   ...
   * Trigger a hover event.
   *
   * @param { (isHover?: boolean, event?: HoverEvent) => void } event callback of onHover, isHover described entry or leave component, use HoverEvent to set up stopPropagation.
   * @returns { T }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @crossplatform
   * @since 10
  ...
  * } } value
   ...
   * @param { ?SheetStyle } style - sheet style type.
