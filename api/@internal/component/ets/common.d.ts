...
/**
 * AnimateToParam in form, duration must less than 1000
 * @form
 * @since 9
 */
export interface AnimateToParamForForm {
  duration?: number;
  curve?: Curve | string;
  playMode?: PlayMode;
  onFinish?: () => void;
 ...
 * @since 9
 */
export declare function animateTo(value: AnimateToParamForForm, event: () => void): void;
...
declare class CommonMethod<T> {
  ...
  /**
   * animation in form duration must less than 1000
   * @form
   * @since 9
   */
  animation(value: {
