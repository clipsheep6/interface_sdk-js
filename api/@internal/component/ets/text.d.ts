...
interface Text extends CommonMethod<Text> {
  ...
  fontColor(value: Color | number | string): Text;

  fontSize(value: number | string): Text;
  ...
  fontFamily(value: string): Text;

  maxLines(value: number): Text;

  decoration(value: { type: TextDecorationType, color?: Color | number | string }): Text;
