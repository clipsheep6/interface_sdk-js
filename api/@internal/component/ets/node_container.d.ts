...
interface NodeContainerInterface {
   ...
   *
   * @param { import('../api/@ohos.arkui.buildernode').NodeController } controller - Indicates the controller of the NodeContainer.
   * @returns { NodeContainerAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 11
   */
    (controller: import('../api/@ohos.arkui.buildernode').NodeController): NodeContainerAttribute;
}
