...
/**
 * Define three states of animation playback.
 * @since 9
 */
declare enum AnimationState {
    /**
     * Play all defined skinning animations.
     * @since 9
     */
    PLAY = 0,

    /**
     * Pause the playback of all animations at current time index.
     * @since 9
     */
    PAUSE = 1,

    /**
     * Stop playback of all animations
     * @since 9
     */
    STOP = 2,
}
...
declare class SceneViewAttribute extends CommonMethod<SceneViewAttribute> {
    ...
    /**
     * Control the playback of glTF.
     * @since 9
     */
    skinningAnimationsState(value: AnimationState): SceneViewAttribute;
