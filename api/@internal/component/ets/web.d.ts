...
declare class WebAttribute extends CommonMethod<WebAttribute> {
  ...
  /**
   * Sets whether the Web supports zooming using on-screen controls or gestures.
   * @param zoomAccess {@code true} means the Web supports zooming using on-screen controls or gestures; {@code false} otherwise.
   *
   * @since 8
   */
