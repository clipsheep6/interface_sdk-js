...
declare class WebAttribute extends CommonMethod<WebAttribute> {
   ...
   *
   * @param { callback: () => void } callback The triggered function when requesting to hide the geolocation permission.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   *
   * @param { (event?: { origin: string; geolocation: JsGeolocation }) => void } callback The triggered function when requesting to show the geolocation permission.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   *
   * @param { (event?: { url: string; message: string; result: JsResult }) => boolean } callback The triggered function when the web page wants to display a JavaScript alert() dialog.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   *
   * @param { (event?: { url: string; message: string; result: JsResult }) => boolean } callback The triggered function when the web page wants to confirm navigation from JavaScript onbeforeunload.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   *
   * @param { (event?: { url: string; message: string; result: JsResult }) => boolean } callback The Triggered function when the web page wants to display a JavaScript confirm() dialog.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   *
   * @param { (event?: { url: string; message: string; value: string; result: JsResult }) => boolean } callback The Triggered function when the web page wants to display a JavaScript prompt() dialog.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 9
   */
  onPrompt(
    callback: (event?: { url: string; message: string; value: string; result: JsResult }) => boolean
  ): WebAttribute;
   ...
   *
   * @param { (event?: { request: WebResourceRequest; error: WebResourceError }) => void } callback The triggered function when the web page receives a web resource loading error.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   *
   * @param { (event?: { request: WebResourceRequest; response: WebResourceResponse }) => void } callback The triggered function when the web page receives a web resource loading HTTP error.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 8
   */
   ...
   */
  onShowFileSelector(
    callback: (event?: { result: FileSelectorResult; fileSelector: FileSelectorParam }) => boolean
  ): WebAttribute;
   ...
   */
  onHttpAuthRequest(
    callback: (event?: { handler: HttpAuthHandler; host: string; realm: string }) => boolean
  ): WebAttribute;

  /**
   * Triggered when the resources loading is intercepted.
   *
   * @param { (event?: { request: WebResourceRequest }) => WebResourceResponse } callback The triggered callback when the resources loading is intercepted.
   ...
   *
   * @param { (event?: { request: PermissionRequest }) => void } callback The triggered callback when the host application that web content from the specified origin is
   ...
   *
   * @param { (event?: { param: WebContextMenuParam; result: WebContextMenuResult }) => boolean } callback The triggered callback when called to allow custom display of the context menu.
   * @returns { WebAttribute } If custom display return true.Otherwise, default display return false.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 9
   */
  onContextMenuShow(
    callback: (event?: { param: WebContextMenuParam; result: WebContextMenuResult }) => boolean
  ): WebAttribute;
  ...
  onSearchResultReceive(
    callback: (event?: { activeMatchOrdinal: number; numberOfMatches: number; isDoneCounting: boolean }) => void
  ): WebAttribute;

  /**
   * Triggered when the scroll bar slides to the specified position.
   *
   * @param { (event: { xOffset: number; yOffset: number }) => void } callback Function Triggered when the scroll bar slides to the specified position.
   * @returns { WebAttribute }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 9
   */
   ...
   * @since 9
   */
  onTouchIconUrlReceived(callback: (event: { url: string; precomposed: boolean }) => void): WebAttribute;
  ...
  onFirstContentfulPaint(
    callback: (event?: { navigationStartTick: number; firstContentfulPaintMs: number }) => void
  ): WebAttribute;
