...
declare class WebAttribute extends CommonMethod<WebAttribute> {
   ...
   *
   * @param { () => void } callback The triggered callback when web controller initialization success.
   * @since 10
   */
   ...
   *
   * @param { (event: { xOffset: number, yOffset: number }) => void } callback Function Triggered when the over scrolling.
   * @syscap SystemCapability.Web.Webview.Core
   * @since 10
   */
