...
declare class WebAttribute extends CommonMethod<WebAttribute> {
   ...
   * Triggered when the Web wants to display a JavaScript alert() dialog.
   *
   * @param {  Callback<OnAlertEvent> } callback The triggered function when the web page wants to display a JavaScript alert() dialog.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onAlert(callback: Callback<OnAlertEvent>): WebAttribute;
   ...
   * Triggered when the Web wants to confirm navigation from JavaScript onbeforeunload.
   *
   * @param { Callback<OnBeforeUnloadEvent> } callback The triggered function when the web page wants to confirm navigation from JavaScript onbeforeunload.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @atomicservice
   * @since 12
   */
  onBeforeUnload(callback: Callback<OnBeforeUnloadEvent>): WebAttribute;
   ...
   * Triggered when the web page wants to display a JavaScript confirm() dialog.
   *
   * @param { Callback<OnConfirmEvent> } callback The triggered function when the web page wants to display a JavaScript confirm() dialog.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onConfirm(callback: Callback<OnConfirmEvent>): WebAttribute;
   ...
   * Triggered when the web page wants to display a JavaScript prompt() dialog.
   *
   * @param { Callback<OnPromptEvent> } callback The triggered function when the web page wants to display a JavaScript prompt() dialog.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onPrompt(callback: Callback<OnPromptEvent>): WebAttribute;
   ...
   * Triggered when the web page receives a JavaScript console message.
   *
   * @param {  Callback<OnConsoleEvent> } callback The triggered function when the web page receives a JavaScript console message.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onConsole(callback: Callback<OnConsoleEvent>): WebAttribute;
   ...
   * Triggered when the file selector shows.
   *
   * @param { Callback<OnShowFileSelectorEvent> } callback The triggered when the file selector shows.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onShowFileSelector(callback: Callback<OnShowFileSelectorEvent>): WebAttribute;
   ...
   * Triggered when the browser needs credentials from the user.
   *
   * @param { Callback<OnHttpAuthRequestEvent> } callback The triggered when the browser needs credentials from the user.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onHttpAuthRequest(callback: Callback<OnHttpAuthRequestEvent>): WebAttribute;
   ...
   * Triggered when the resources loading is intercepted.
   *
   * @param { Callback<OnInterceptRequestEvent> } callback The triggered callback when the resources loading is intercepted.
   * @returns { WebAttribute } If the response value is null, the Web will continue to load the resources. Otherwise, the response value will be used
   * @syscap SystemCapability.Web.Webview.Core
   * @atomicservice
   * @since 12
   */
  onInterceptRequest(callback: Callback<OnInterceptRequestEvent>): WebAttribute;
   ...
   * Triggered when called to allow custom display of the context menu.
   *
   * @param { Callback<OnContextMenuShowEvent> } callback The triggered callback when called to allow custom display of the context menu.
   * @returns { WebAttribute } If custom display return true.Otherwise, default display return false.
   * @syscap SystemCapability.Web.Webview.Core
   * @atomicservice
   * @since 12
   */
  onContextMenuShow(callback: Callback<OnContextMenuShowEvent>): WebAttribute;
   ...
   * Triggered when the resources loading is intercepted.
   *
   * @param { Callback<OnLoadInterceptEvent> } callback The triggered callback when the resources loading is intercepted.
   * @returns { WebAttribute }
   * @syscap SystemCapability.Web.Webview.Core
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  onLoadIntercept(callback: Callback<OnLoadInterceptEvent>): WebAttribute;
