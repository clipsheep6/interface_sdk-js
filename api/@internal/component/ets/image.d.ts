...
import {CommonMethod, ImageRepeat, ImageFit} from "./common";
...
interface Image extends CommonMethod<Image> {
  ...
  onComplete(callback: (event?: { width: number, height: number }) => void): Image;

  onError(event: () => void): Image;
