...
declare class CanvasGradient {
   ...
   * @param string RGB cubic-coordinate system color value <color>. If the color value cannot be resolved to a valid RGB cubic-coordinate system color value <color>
