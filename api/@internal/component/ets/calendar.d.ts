...
export interface CurrentDayStyle {
  dayColor?: Color | number | string;
  lunarColor?: Color | number | string;
  markLunarColor?: Color | number | string;
  dayFontSize?: number;
...
export interface NonCurrentDayStyle {
  nonCurrentMonthDayColor?: Color | number | string;
  nonCurrentMonthLunarColor?: Color | number | string;
  nonCurrentMonthWorkDayMarkColor?: Color | number | string;
  nonCurrentMonthOffDayMarkColor?: Color | number | string;
}

export interface TodayStyle {
  focusedDayColor?: Color | number | string;
  focusedLunarColor?: Color | number | string;
  focusedAreaBackgroundColor?: Color | number | string;
  focusedAreaRadius?: number;
}

export interface WeekStyle {
  weekColor?: Color | number | string;
  weekendDayColor?: Color | number | string;
  weekendLunarColor?: Color | number | string;
  weekFontSize?: number;
  weekHeight?: number;
  weekWidth?: number;
...
export interface WorkStateStyle {
  workDayMarkColor?: Color | number | string;
  offDayMarkColor?: Color | number | string;
