...
declare enum SecPasteButtonOnClickResult {
   ...
   * @since 10
   */
  APPLY_FOR_TEMPORARY_AUTHORIZATION_FAILED = 1
}
...
interface SecPasteButtonInterface {
   ...
   *
   * @param { SecPasteButtonOptions } option - Indicates the options of the paste button.
   * @returns { SecPasteButtonAttribute } Returns the attribute of the paste button.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 10
   */
 ...
 * @since 10
 */
declare class SecPasteButtonAttribute extends SecCompButtonAttribute {
  /**
   * Layout direction of the icon and text.
   *
   * @param { SecPasteButtonLayoutDirection } value - Indicates the layout direction of the icon and text.
   * @returns { SecPasteButtonAttribute } Returns the attribute of the paste button.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 10
   */
  layoutDirection(value: SecPasteButtonLayoutDirection): SecPasteButtonAttribute;

  /**
   * Layout order of the icon and text.
   *
   * @param { SecPasteButtonLayoutOrder } value - Indicates the layout order of the icon and text.
   * @returns { SecPasteButtonAttribute } Returns the attribute of the paste button.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @since 10
   */
  layoutOrder(value: SecPasteButtonLayoutOrder): SecPasteButtonAttribute;
   ...
   * @since 10
   */
  onClick(event: (event: ClickEvent, result: SecSaveButtonOnClickResult) => void): SecPasteButtonAttribute;
}
