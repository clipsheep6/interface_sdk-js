...
declare class RichEditorBaseController extends TextSelectionController, TextEditController, StyledStringController {
  ...
  /**
   * Registered content change listening
   * @param { TextChangeListener | StyledStringChangedListener } value - content change listening.
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @crossplatform
   * @since 12
   */
  onContentChanged(value: TextChangeListener | StyledStringChangedListener): void;
}
