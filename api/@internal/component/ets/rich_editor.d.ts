...
declare interface RichEditorOptions {
   ...
   * RichEditor controller.
   *
   * @type { RichEditorController | RichEditorStyledStringController }
   * @syscap SystemCapability.ArkUI.ArkUI.Full
   * @crossplatform
   * @atomicservice
   * @since 12
   */
  controller: RichEditorController | RichEditorStyledStringController;
}
 ...
 * @since 12
 */
declare class RichEditorBaseController extends TextSelectionController, TextEditController, StyledStringController {
  /**
...
declare class RichEditorStyledStringController extends RichEditorBaseController {
  ...
  /**
   * Get the selection in StyledString.
   *
   ...
   * @since 12
   */
  getStyledStringSelection(): RichEditorRange;
}
