...
declare namespace backup {
   ...
   * @since 11
   */
  function getLocalCapabilities(dataList: Array<IncrementalBackupTime>, callback: AsyncCallback<FileData>): void;
  ...
  class SessionBackup {
     ...
     *
     * @permission ohos.permission.BACKUP
     * @param { AsyncCallback<void> } callback Asynchronous callback to be called when release has finished.
     * @throws { BusinessError } 201 - Permission verification failed, usually the result returned by VerifyAccessToken.
     * @throws { BusinessError } 202 - Permission verification failed, application which is not a system application uses system API.
  ...
  class IncrementalBackupSession {
     ...
     * @since 11
     */
    appendBundles(bundlesToBackup: Array<IncrementalBackupData>, callback: AsyncCallback<void>): void;
