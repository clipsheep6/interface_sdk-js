...
declare namespace list {
  class List<T> {
     ...
     * @param callbackfn (required) A function that accepts up to four arguments.The function to be called for each element in the list,Returns the result of an operation
     ...
     * @param comparator (required) A function that accepts up to two arguments.Specifies the sort order. Must be a function,return number type,
     * If it returns firstValue minus secondValue, it returns an list sorted in ascending order;
     * If it returns secondValue minus firstValue, it returns an list sorted in descending order;
     ...
     * @param callbackfn (required) A function that accepts up to four arguments.The function to be called for each element in the vector,Returns the result of an operation
     * @param Value (required) current element
     * @param Index (Optional) The index value of the current element.
     * @param list (Optional) The list object to which the current element belongs.
     * @param thisArg (Optional) The value passed to the function generally uses the "this" value.
