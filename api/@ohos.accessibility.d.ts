...
declare namespace accessibility {
    ...
    */
     ...
     * @return Returns the list of abilityInfos.
    */
    function getAbilityLists(abilityType: 'all', stateType: AbilityState, callback: AsyncCallback<Array<AccessibilityAbilityInfo>>): void;
    function getAbilityLists(abilityType: 'all', stateType: AbilityState): Promise<Array<AccessibilityAbilityInfo>>;
    /**
