...
declare namespace window {
  ...
  interface Window {
     ...
     * @since 7
     * @deprecated since 9
     * @useinstead ohos.window/window.Window#on_avoidAreaChange
     */
     ...
     * @since 7
     * @deprecated since 9
     * @useinstead ohos.window/window.Window#off_avoidAreaChange
     */
     ...
     *
     * @param { 'avoidAreaChange' } type - The value is fixed at 'avoidAreaChange', indicating the event of changes to the area where the window cannot be displayed.
     * @param { Callback<{type: AvoidAreaType;area: AvoidArea;}> } callback - Callback used to return the area and area type.
     * @throws { BusinessError } 401 - If param is invalid
     * @syscap SystemCapability.WindowManager.WindowManager.Core
     * @since 9
     */
