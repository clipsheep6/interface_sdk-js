...
export default class InsightIntentExecutor {
   ...
   * @returns { insightIntent.ExecuteResult | Promise<insightIntent.ExecuteResult> } The result of insight intent executation, support promise.
