...
declare namespace backup {
  ...
  interface GeneralCallbacks {
     ...
     * @since 10
     */
    onBundleStarted: AsyncCallback<string>;
     ...
     * @since 10
     */
    onBundleFinished: AsyncCallback<string>;
     ...
     * @since 10
     */
    onAllBundlesFinished: AsyncCallback<void>;
     ...
     * @since 10
     */
    onBackupServiceDied: Callback<void>;
  }

  /**
   * General interface for both backup and restore procedure.
   *
   * @interface SessionGeneral
   * @syscap SystemCapability.FileManagement.StorageService.Backup
   * @since 10
   */
  interface SessionGeneral {
    /**
     * Start to backup/restore.
     *
     ...
     * Start to backup/restore.
     *
     * @param { AsyncCallback<void> } callback Asynchronous callback to be called when start has finished.
     * @syscap SystemCapability.FileManagement.StorageService.Backup
     * @since 10
     */
    ...
    /**
     * Notify the backup service to refuse appending bundles to backup/restore
     * so that both the client and service are able to release certain resources.
     *
     * @returns { Promise<void> }
     * @syscap SystemCapability.FileManagement.StorageService.Backup
     * @since 10
     ...
     * so that both the client and service are able to release certain resources.
     *
     * @param { AsyncCallback<void> } callback Asynchronous callback to be called when finish has finished.
     * @syscap SystemCapability.FileManagement.StorageService.Backup
     * @since 10
     */
    finish(callback: AsyncCallback<void>): void;
  }
   ...
   * @since 10
   */
  class SessionBackup implements SessionGeneral {
    /**
    ...
    /**
     * Notify the backup service to refuse appending bundles to backup so that
     * both the client and service are able to release certain resources.
     *
     * @permission ohos.permission.BACKUP
     * @returns { Promise<void> }
     * @throws { BusinessError } 13600001 - IPC error
   ...
   * @since 10
   */
  class SessionRestore implements SessionGeneral {
    /**
     * Constructor for obtaining the instance of the SessionBackup class.
     *
     * @permission ohos.permission.BACKUP
    ...
    /**
     * Notify the backup service to refuse appending bundles to restore so that
     * both the client and service are able to release certain resources.
     *
     * @permission ohos.permission.BACKUP
     * @returns { Promise<void> }
