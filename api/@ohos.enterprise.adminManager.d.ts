...
declare namespace adminManager {
  ...
  export enum AdminType {
    /**
     * The value of normal admin.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
    ADMIN_TYPE_NORMAL = 0x00,
    /**
     * The value of super admin.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
  ...
  export enum ManagedEvent {
    ...
    /**
     * The event of get paste board.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
    MANAGED_EVENT_PASTE_BOARD_GET = 4,
    /**
     * The event of set paste board.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
    MANAGED_EVENT_PASTE_BOARD_SET = 5,
    /**
     * The event of paste screenshot.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
    MANAGED_EVENT_PASTE_SCREENSHOT = 6,
    /**
     * The event of share screen start.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
    MANAGED_EVENT_SHARE_SCREEN_START = 7,
    /**
     * The event of share screen stop.
     * @syscap SystemCapability.Customization.EnterpriseDeviceManager
     * @since 9
     */
   ...
   * @throws { BusinessError } 9200004 - failed to activate the adminstrator application of the device.
   * @throws { BusinessError } 9200006 - the specified user ID is invalid.
   ...
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { number } [userId] - userId indicates the user ID or do not pass user ID.
   * @param { AsyncCallback<boolean> } callback - the callback of isAdminEnabled.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200006 - the specified user ID is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 401 - invalid input parameter.
   ...
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { number } [userId] - userId indicates the user ID or do not pass user ID.
   * @returns { Promise<boolean> } the promise returned by the isAdminEnabled.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200006 - the specified user ID is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 401 - invalid input parameter.
   ...
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { AsyncCallback<EnterpriseInfo> } callback - the callback of getEnterpriseInfo.
   ...
   * @permission ohos.permission.SET_ENTERPRISE_INFO
   * @param { Want } admin - admin indicates the administrator ability information.
   * @returns { Promise<EnterpriseInfo> } the promise returned by the getEnterpriseInfo.
   * @throws { BusinessError } 9200001 - the applicayion is not an administrator of the device.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 201 - the application does not have permission to call this function.
   ...
   * @param { string } bundleName - bundleName indicates the administrator bundle information.
   * @param { AsyncCallback<boolean> } callback - the callback of isSuperAdmin.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 401 - invalid input parameter.
   * @syscap SystemCapability.Customization.EnterpriseDeviceManager
   * @systemapi
   ...
   * Get whether the ability is enabled as super device administrator.
   * @param { string } bundleName - bundleName indicates the administrator bundle information.
   * @returns { Promise<boolean> } the promise returned by the isSuperAdmin.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 401 - invalid input parameter.
   * @syscap SystemCapability.Customization.EnterpriseDeviceManager
   * @systemapi
