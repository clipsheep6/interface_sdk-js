...
declare namespace vector {
  class Vector<T> {
     ...
     * @param callbackfn (required) A function that accepts up to four arguments.The function to be called for each element in the vector
     * @param Value (required) current element
     * @param Index (Optional) The index value of the current element.
     * @param vector (Optional) The vector object to which the current element belongs.
     * @param thisArg (Optional) The value passed to the function generally uses the "this" value.
    ...
    thisArg?: Object): void;
    /**
     * Sorts this vector according to the order induced by the specified comparator,without comparator this parameter, it will default to ASCII sorting
     ...
     * If it returns firstValue minus secondValue, it returns an vector sorted in ascending order;
     * If it returns secondValue minus firstValue, it returns an vector sorted in descending order;
