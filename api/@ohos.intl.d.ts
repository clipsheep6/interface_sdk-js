...
/**
 * Provides the API for collation.
 */
export class Collator {
     ...
     * @since 8
     */
    constructor(locale: string, options?: CollatorOptions);

    /**
     * A constructor used to create Collator Object;
     *
     * @param locale Indicates a character string Array containing the locales information, including
     *               the language and optionally the script and region, for the Collator object.
     * @param option Indicates the options used to initialize Collator object.
     * @since 8
     */
    constructor(locale: Array<string>, option?: CollatorOptions);
...
/**
 * Provides the API for PluralRules.
 */
export class PluralRules {
     ...
     * A constructor used to create PluralRules object.
     *
     * @param locale Indicates character strings containing the locales information, including
     *               the language and optionally the script and region, for the PluralRules object.
     * @param options Indicates the options used to initialize PluralRules object.
     * @since 8
     */
    constructor(locale: Array<string>, options?: PluralRulesOptions);

    /**
     * Returns a string indicating which plural rule to use for locale-aware formatting.
     *
     * @param number The number to get a plural rule for.
