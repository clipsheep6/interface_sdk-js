...
declare namespace applicationManager {
  /**
   * Add appid list of applications that not allowed running in the device.
   * Only apps with the ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { Array<string> } appIds - ids of the application that not allowed running.
  ...
  /**
   * Remove appid list of applications that not allowed running in the device.
   * Only apps with the ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { Array<string> } appIds - ids of the application that not allowed running.
  ...
  /**
   * Get the appid list of applications that not allowed running in the device.
   * Only apps with the ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
  ...
  /**
   * Get appid list of applications that not allowed running in the device.
   * Only apps with the ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_MANAGE_SET_APP_RUNNING_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { number } [userId] - userId indicates the user ID or do not pass user ID.
