...
declare namespace AppReceovery {
    ...
    enum SaveFlags {
       /**
        * SAVE_DEFAULT is saving with default.
        * @since 9
        */
       SAVE_DEFAULT = 0,
    ...
    /**
     * Is app supports save and restore
     * @since 9
     * @syscap SystemCapability.HiviewDFX.Hiview.AppReceovery
     ...
     */
    function enableAppRecovery(restartFlags: RestartFlags, saveFlags: SaveFlags, saveMode: SaveMode) : boolean;
}
