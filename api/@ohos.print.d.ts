...
declare namespace print {
	...
	interface PrintJob {
		...
		isLandscape?: bool;			// vertical printing
		colorMode?: number;			// color mode
		duplexMode?: number;		// duplex mode
	 ...
	 * @return -
	 */
	function queryExtensionAbilityInfosByWant(callback: AsyncCallback<Array<PrinterExtensionInfo>>): void;
	function queryExtensionAbilityInfosByWant(): Promise<Array<PrinterExtensionInfo>>;
