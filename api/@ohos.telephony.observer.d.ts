...
declare namespace observer {
   ...
   *
   * @param { string } type - cellularDataConnectionStateChange.
   * @param { Callback<{ state: DataConnectState, network: RatType }> } callback - Indicates the callback to unsubscribe from
   * the cellularDataConnectionStateChange event.
   * @throws { BusinessError } 401 - Parameter error.
   * @throws { BusinessError } 8300001 - Invalid parameter value.
   * @throws { BusinessError } 8300002 - Operation failed. Cannot connect to service.
   * @throws { BusinessError } 8300003 - System internal error.
  ...
  export enum LockReason {
    ...
    /**
     * Indicates the network PIN lock(refer 3GPP TS 22.022 [33]).
     */
    SIM_PN_PIN,

    /**
     * Indicates the network PUK lock.
     */
    SIM_PN_PUK,

    /**
     * Indicates the subnet PIN lock(refer 3GPP TS 22.022 [33]).
     */
    SIM_PU_PIN,

    /**
     * Indicates the subnet PUK lock.
     */
    SIM_PU_PUK,

    /**
     * Indicates the service provider PIN lock(refer 3GPP TS 22.022 [33]).
     */
    SIM_PP_PIN,

    /**
     * Indicates the service provider PUK lock.
     */
    SIM_PP_PUK,

    /**
     * Indicates the organizational PIN lock(refer 3GPP TS 22.022 [33]).
     */
    SIM_PC_PIN,

    /**
     * Indicates the organizational PUK lock.
     */
    SIM_PC_PUK,

    /**
     * Indicates the SIM PIN lock.(refer 3GPP TS 22.022 [33]).
     */
    SIM_SIM_PIN,

    /**
     * Indicates the SIM PUK lock.
     */
    SIM_SIM_PUK,
  }
}
