...
export class UIObserver {
  ...
  /**
   * Registers a callback function to be called before or after tapGesture is called.
   *
   * @param { 'willClick' } type - The type of event to listen for.
  ...
  /**
   * Removes a callback function to be called before or after tapGesture is called.
   *
   * @param { 'willClick' } type - The type of event to remove the listener for.
