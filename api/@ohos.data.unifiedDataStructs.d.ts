...
import {File, SystemDefinedRecord} from "./@ohos.data.unifiedDataChannel";
import Want from "./@ohos.app.ability.Want";

/**
 * Provide methods for sharing struct between different applications across unified data channels.
 *
...
declare namespace unifiedDataStructs {
    ...
    class UnifiedDataStruct {
        utdType: string;
        /**
         * Indicates the details of system defined struct
         *
         * @syscap SystemCapability.DistributedDataManager.UDMF.Core
         * @atomicservice
         * @since 12
     ...
     * @since 12
     */
    class PlainText extends UnifiedDataStruct {
        /**
     ...
     * @since 12
     */
    class Hyperlink extends UnifiedDataStruct {
        /**
     ...
     * @since 12
     */
    class HTML extends UnifiedDataStruct {
     ...
     * @since 12
     */
    class File extends UnifiedDataStruct {
        /**
    ...
    /**
     * Describe the unified image struct
     *
     * @extends UnifiedDataStruct
     * @syscap SystemCapability.DistributedDataManager.UDMF.Core
     * @atomicservice
     * @since 12
     */
    class Image extends UnifiedDataStruct {
        ...
        imageUri: string;
        /**
         * Indicates the raw struct of pixel map
         *
         * @syscap SystemCapability.DistributedDataManager.UDMF.Core
         * @atomicservice
         * @since 12
         */
        rawData: Uint8Array; // 必选？
    }
    /**
     ...
     * @since 12
     */
    class Folder extends UnifiedDataStruct {
     ...
     * @since 12
     */
    class OpenHarmonyForm extends UnifiedDataStruct {
        /**
     ...
     * @since 12
     */
    class OpenHarmonyAppItem extends SystemDefinedRecord {
        /**
     ...
     * @since 12
     */
    class OpenHarmonyWant extends UnifiedDataStruct {
        /**
