...
export enum AutoFillType {
  ...
  /**
   * Indicates the type of precise time.
   *
   * @syscap SystemCapability.Ability.AbilityRuntime.AbilityCore
   * @systemapi
   * @StageModelOnly
  ...
  /**
   * Indicates the type of hour and minute.
   *
   * @syscap SystemCapability.Ability.AbilityRuntime.AbilityCore
   * @systemapi
   * @StageModelOnly
  ...
  /**
   * Indicates the type of nick name.
   *
