...
export default class UIExtensionContext extends ExtensionContext {
   ...
   * @throws { BusinessError } 16000074 - The target app instance of the given key does not exist.
   * @throws { BusinessError } 16000075 - The number of app instances reaches the limit.
   * @syscap SystemCapability.Ability.AbilityRuntime.Core
   * @stagemodelonly
   * @since 12
   */
