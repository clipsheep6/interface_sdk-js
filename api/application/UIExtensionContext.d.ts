...
export default class UIExtensionContext extends ExtensionContext {
   ...
   * If the target UI service extension ability is in cross-device, you need to apply for permission:ohos.permission.DISTRIBUTED_DATASYNC.
   *
   ...
   * @since 12
   */
  startUIServiceExtension(want: Want): Promise<void>;
   ...
   * @param { function } [callback] - The callback to receive data.
   ...
   * @since 12
   */
  connectUIServiceExtensionAbility(want: Want, callback?: (data: Record<string, Object>) => void): Promise<UIServiceProxy>;
   ...
   * @since 12
   */
  disconnectServiceExtensionAbility(proxy: UIServiceProxy): Promise<void>;
}
