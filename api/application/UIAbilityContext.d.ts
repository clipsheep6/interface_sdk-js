...
export default class UIAbilityContext extends Context {
   ...
   * @throws { BusinessError } 16000055 - Installation-free timed out.
   * @throws { BusinessError } 16200001 - The caller has been released.
   * @throws { BusinessError } 16000073 - The target isolation index app does not exist.
   * @throws { BusinessError } 16000074 - The target app instance for give key does not exist.
   * @throws { BusinessError } 16000075 - The app instance reach to limit, can not new instance any more.
   * @syscap SystemCapability.Ability.AbilityRuntime.Core
   * @stagemodelonly
   * @crossplatform
   * @atomicservice
