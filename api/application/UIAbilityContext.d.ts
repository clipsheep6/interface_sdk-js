...
export default class UIAbilityContext extends Context {
   ...
   * @param { Callback<Record<string, Object>> } [dataReceivedCallback] - The callback to receive data.
   ...
   * @since 12
   */
  connectUIServiceExtensionAbility(want: Want, dataReceivedCallback?: Callback<Record<string, Object>>) : Promise<UIServiceProxy>;
