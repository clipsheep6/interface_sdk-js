...
declare namespace relationalStore {
  ...
  interface RdbStore {
     ...
     * @returns { ModifyTime } the modify time of current row. if this table does not support cloud, the {@link ModifyTime} will be empty.
     ...
     * @since 10
     */
    getModifyTime(table: string, columnName: string, primaryKeys: PRIKeyType[]): ModifyTime;
     ...
     * @permission ohos.permission.DISTRIBUTED_DATASYNC
     * @param { Array<string> } tables - indicates the tables name you want to set.
     * @param { DistributedType } mode - indicates the tables distributed type {@link DistributedType}.
     * @param { AsyncCallback<void> } callback - the callback of setDistributedTables.
     * @throws { BusinessError } 401 - Parameter error.
     * @throws { BusinessError } 14800000 - Inner error.
     * @throws { BusinessError } 801 - Capability not supported.
