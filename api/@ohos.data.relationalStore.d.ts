...
declare namespace relationalStore {
  ...
  interface RdbStore {
     ...
     * @throws { BusinessError } 14800000 - Inner error.
     * @throws { BusinessError } 401 - Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types;
     * 3. Parameter verification failed. Possible causes: 1. Need 3 - 4  parameter(s)! 2. The RdbStore must be not nullptr.
     ...
     * @throws { BusinessError } 14800000 - Inner error.
     * @throws { BusinessError } 401 - Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types;
     * 3. Parameter verification failed. Possible causes: 1. Need 1 - 3  parameter(s)! 2. The RdbStore must be not nullptr.
     ...
     * @throws { BusinessError } 401 - Parameter error. Possible causes: 1. Mandatory parameters are left unspecified; 2. Incorrect parameter types;
     * 3. Parameter verification failed. Possible causes: 1. Need 2 - 4  parameter(s). 2. The RdbStore must be not nullptr.
