...
declare namespace socket {
  ...
  export interface TLSSocket {
     ...
     * @throws {BusinessError} 2300201 - Permission denied
     ...
     * @permission ohos.permission.INTERNET
     * @throws {BusinessError} 2300201 - Permission denied
     * @throws {BusinessError} 2303114 - Bad address.
     * @throws {BusinessError} 2303122 - Invalid system argument.
     * @throws {BusinessError} 2303188 - Socket operation on non-socket.
     * @throws {BusinessError} 2303600 - No bind socket.
     */
    getRemoteAddress(callback: AsyncCallback<NetAddress>): void;
    getRemoteAddress(): Promise<NetAddress>;
