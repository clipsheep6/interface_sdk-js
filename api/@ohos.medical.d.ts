...
declare namespace medical {
     ...
     * @since 8
     */
    function on(type: MedicalSensorType, callback: Callback<PpgResponse>, options?: Options): void;
     ...
     * @since 8
     */
    function off(type: MedicalSensorType, callback?: Callback<PpgResponse>): void;
    ...
    interface PpgResponse {
        dataArray: Array<number>; /**< Photoplethysmography data */
    }
 }
