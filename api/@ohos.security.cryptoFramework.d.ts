...
declare namespace cryptoFramework {
    ...
    interface IvParamsSpec extends ParamsSpec {
        /**
         * indicate the algorithm parameters such as iv.
         *
         * @sysCap SystemCapability.Security.CryptoFramework.
         * @since 9
         */
    ...
    interface GcmParamsSpec extends ParamsSpec {
        /**
         * indicate the GCM algorithm parameters such as iv.
         *
         * @sysCap SystemCapability.Security.CryptoFramework.
         * @since 9
         */
        ...
        /**
         * indicate the GCM additional message for integrity check.
         *
         * @sysCap SystemCapability.Security.CryptoFramework.
         * @since 9
         */
        ...
        /**
         * indicate the GCM Authenticated Data.
         *
         * @sysCap SystemCapability.Security.CryptoFramework.
         * @since 9
         */
    ...
    interface CcmParamsSpec extends ParamsSpec {
        ...
        /**
         * indicate the CCM additional message for integrity check.
         *
         * @sysCap SystemCapability.Security.CryptoFramework.
         * @since 9
         */
        ...
        /**
         * indicate the CCM Authenticated Data.
         *
         * @sysCap SystemCapability.Security.CryptoFramework.
         * @since 9
         */
