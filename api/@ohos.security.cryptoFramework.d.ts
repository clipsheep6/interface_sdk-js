...
declare namespace cryptoFramework {
    ...
    /**
     * Provides the asymetric keyPair type.
     * @typedef KeyPair
     * @syscap SystemCapability.Security.CryptoFramework
     * @since 9
     */
    ...
    interface Random {
         ...
         * @return Returns the generated random blob.
     ...
     * @return Returns the created rand instance.
     * @throws { BusinessError } 19020001 - memory error.
     * @syscap SystemCapability.Security.CryptoFramework
     * @since 9
     */
     ...
     */
     interface AsyKeyGenerator {
        ...
        /**
         * Used to convert asymetric key pair .
    ...
    interface Mac {
         ...
         * @return Returns the calculated hmac result.
         * @throws { BusinessError } 19020001 - memory error.
         * @throws { BusinessError } 19030001 - crypto operation error.
         * @syscap SystemCapability.Security.CryptoFramework
         * @since 9
         ...
         * @return Returns the length of the hmac result.
         * @throws { BusinessError } 19030001 - crypto operation error.
         * @syscap SystemCapability.Security.CryptoFramework
         * @since 9
         */
     ...
     * @return Returns the created mac instance.
     * @throws { BusinessError } 401 - invalid parameters.
     * @throws { BusinessError } 19020001 - memory error.
     * @syscap SystemCapability.Security.CryptoFramework
     * @since 9
     ...
     * @return Returns the created md instance.
     * @throws { BusinessError } 401 - invalid parameters.
     * @throws { BusinessError } 19020001 - memory error.
     * @syscap SystemCapability.Security.CryptoFramework
     * @since 9
