...
declare namespace rpc {
   ...
   */
  /**
   * The proxy holder of the remote object. Used to get the proxy object.
   * 
   * @typedef IRemoteBroker
   * @syscap SystemCapability.Communication.IPC.Core
   * @since 11
   ...
   * <p> When a remote object subscribed to the notification dies, the local end can receive a message and call
