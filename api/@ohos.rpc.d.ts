...
declare namespace rpc {
  ...
  class MessageParcel {
     ...
     * @returns { boolean } Return true if it is successful; return false otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 7
     * @deprecated since 9
     */
     ...
     * @returns { boolean } Return {@code true} if the {@link IRemoteObject} array is successfully written to the {@link MessageParcel};
     ...
     *
     * @param { Sequenceable } dataIn - Indicates the {@link Sequenceable} object that needs to perform the {@code unmarshalling} operation
     ...
     *
     * @param { IRemoteObject[] } objects - Reads data from this {@link MessageParcel} object to the specified {@link IRemoteObject} array.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     * @returns { number } A duplicated file descriptor.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @returns { boolean } Return true if the {@link MessageParcel} object contains a file descriptor;
  ...
  class MessageSequence {
     ...
     *
     * @param { Parcelable } dataIn - Indicates the {@link Parcelable} object that needs to perform the {@code unmarshalling} operation
     ...
     *
     * @param { IRemoteObject[] } objects - Reads data from this {@link MessageSequence} object to the specified {@link IRemoteObject} array.
     * @throws { BusinessError } 401 - check param failed
     * @throws { BusinessError } 1900010 - read data from message sequence failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     ...
     *
     * @returns { boolean } Return true if the {@link MessageSequence} object contains a file descriptor;
     * return false otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
  ...
  abstract class IRemoteObject {
     ...
     * @returns { boolean } Return {@code true} if the callback is registered successfully; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 7
     * @deprecated since 9
     ...
     * @param { number } flags - Indicates the flag of the death notification.
     * @returns { boolean } Return {@code true} if the callback is unregister successfully; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 7
     * @deprecated since 9
  ...
  class RemoteProxy implements IRemoteObject {
     ...
     *
     * @param { DeathRecipient } recipient - Indicates the callback to be registered.
     * @param { number } flags - Indicates the flag of the death notification. This is a reserved parameter. Set it to {@code 0}.
     * @returns { boolean } Return {@code true} if the callback is registered successfully; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 7
     * @deprecated since 9
  ...
  class Ashmem {
     ...
     * @param { number } offset - Start position of the data to write in the memory region associated with this Ashmem object.
     * @returns { boolean } Return true is the data is written successfully; return false otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     * @param { number } offset - Start position of the data to read in the memory region associated with this Ashmem object.
