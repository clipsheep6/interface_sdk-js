...
declare namespace rpc {
  ...
  class MessageParcel {
     ...
     * <p>Writable data space = Storage capacity of the {@link MessageParcel} – Size of data contained in
     * the {@link MessageParcel}.
     *
  ...
  abstract class IRemoteObject {
     ...
     *
     * @param { number } code - Indicates the message code called by the request, which is determined by the client and
     * server. If the method is generated by an IDL tool, the message code is automatically generated by the IDL tool.
  ...
  class Ashmem {
     ...
     *
     * @param { number } mapType - Indicates the protection level of the memory region to which the shared file
     *                   is mapped.
     * @returns { boolean } Return {@code true} if the operation is successful; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     ...
     * @returns { boolean } Return {@code true} is the data is written successfully;
     *                      return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
