...
declare namespace rpc {
  ...
  class MessageParcel {
     ...
     *
     * @param { IRemoteObject[] } objectArray - Indicates the {@link IRemoteObject} object array to write.
     * @returns { boolean } Return {@code true} if the {@link IRemoteObject} array is successfully written to 
     *                      the {@link MessageParcel}; return {@code false} if the {@link IRemoteObject} array is null 
     *                      or fails to be written to the {@link MessageParcel}.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @returns { IRemoteObject[] } Return an array of {@link IRemoteObject} object.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @param { number } fd - Indicates the file descriptor to be closed.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @param { number } fd - Indicates the file descriptor to be duplicated.
     ...
     *
     * @param { number } fd - Indicates the file descriptor to wrote.
     ...
     *
     * @returns { number } Return a file descriptor.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @param { Ashmem } ashmem - Indicates the anonymous shared memory object to wrote.
     * @returns { boolean } Return {@code true} if the operation is successful; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     *
     * @returns { Ashmem } Return the anonymous share object.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @returns { number } Return the maximum amount of raw data that a MessageParcel can hold, which is 128 MB.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
     ...
     *
     * @param { number[] } rawData - Indicates the raw data to wrote.
     * @param { number } size - Indicates the size of the raw data, in bytes.
     * @returns { boolean } Return {@code true} if the operation is successful; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     *
     * @param { number } size - Indicates the size of the raw data to read.
     * @returns { number[] } Return the raw data, in bytes.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     */
  ...
  class MessageSequence {
     ...
     *
     * @param { IRemoteObject } object - Indicates the remote object to serialize.
     ...
     *
     * @param { string } token - Indicates the interface descriptor to write.
     * @throws { BusinessError } 401 - check param failed
     * @throws { BusinessError } 1900009 - write data to message sequence failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     ...
     *
     * @returns { string } Return the interface token.
     * @throws { BusinessError } 1900010 - read data from message sequence failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
     ...
     *
     * @param { Parcelable[] } parcelableArray - Indicates the parcelable array to read.
     * @throws { BusinessError } 401 - check param failed
     * @throws { BusinessError } 1900010 - read data from message sequence failed
     * @throws { BusinessError } 1900012 - call js callback function failed
     * @syscap SystemCapability.Communication.IPC.Core
     ...
     *
     * @param { IRemoteObject[] } objects - Indicates the data from this {@link MessageSequence} object to
     *                            the specified {@link IRemoteObject} array to read.
     * @throws { BusinessError } 401 - check param failed
     * @throws { BusinessError } 1900010 - read data from message sequence failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     ...
     *
     * @returns { IRemoteObject[] } Return an array of {@link IRemoteObject} objects.
     * @throws { BusinessError } 1900010 - read data from message sequence failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
     ...
     *
     * @param { Ashmem } ashmem - Indicates an anonymous shared memory object to wrote.
     * @throws { BusinessError } 401 - check param failed
     ...
     * Obtains the maximum amount of raw data that can be sent in a time.
     *
     * @returns { number } Returns the maximum amount of raw data that a MessageParcel can hold, which is 128 MB.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
    getRawDataCapacity(): number;
  ...
  abstract class IRemoteObject {
     ...
     *
     * @param { number } code - Indicates the message code called by the request, which is determined by the client and server.
     * If the method is generated by an IDL tool, the message code is automatically generated by the IDL tool.
     * @param { MessageParcel } data - Indicates the {@link MessageParcel} object holding the data to send.
     * @param { MessageParcel } reply - Indicates the {@link MessageParcel} object that receives the response.
     * @param { MessageOption } options - Indicates the synchronous or asynchronous mode to send messages.
     ...
     * @param { number } code - Indicates the message code called by the request, which is determined by the client and server.
     * If the method is generated by an IDL tool, the message code is automatically generated by the IDL tool.
     * @param { MessageSequence } data - Indicates the {@link MessageSequence} object holding the data to send.
     * @param { MessageSequence } reply - Indicates the {@link MessageSequence} object that receives the response.
     * @param { MessageOption } options - Indicates the synchronous or asynchronous mode to send messages.
     * @returns { Promise<RequestResult> } Returns the promise of the {@link RequestResult} instance.
     * @throws { BusinessError } 401 - check param failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
     ...
     * @param { MessageParcel } reply - Indicates the {@link MessageParcel} object that receives the response.
     * @param { MessageOption } options - Indicates the synchronous or asynchronous mode to send messages.
     * @param { AsyncCallback<SendRequestResult> } callback - Indicates the callback for receiving the sending result.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     * @useinstead ohos.rpc.IRemoteObject#sendMessageRequest
     ...
     * @param { MessageSequence } reply - Indicates the {@link MessageSequence} object that receives the response.
     * @param { MessageOption } options - Indicates the synchronous or asynchronous mode to send messages.
     * @param { AsyncCallback<RequestResult> } callback - Indicates the callback for receiving the sending result.
     * @throws { BusinessError } 401 - check param failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
  ...
  class MessageOption {
     ...
     *
     * @param { number } syncFlags - Indicates that SendRequest is called synchronously (default) or asynchronously.
     * @param { number } waitTime - Indicates the maximum wait time for a RPC call. The default value is TF_WAIT_TIME.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 7
     */
     ...
     * A constructor used to create a MessageOption instance.
     *
     * @param { boolean } async - Indicates whether it is set to asynchronous.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
    ...
    /**
     * Obtains the flag in the SendMessageRequest call that determines whether it is synchronous or asynchronous.
     *
     * @returns { boolean } Return whether the SendRequest is called synchronously or asynchronously.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
    isAsync(): boolean;
    ...
    /**
     * Sets the flag in the SendMessageRequest call to determine whether it is synchronous or asynchronous.
     *
     * @param { boolean } async - Indicates whether it is set to asynchronous.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     ...
     *
     * @param { number } waitTime - Indicates the maximum wait time to set.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 7
     */
  ...
  class RemoteObject extends IRemoteObject {
     ...
     * @returns { IRemoteBroker } Return the remote object matching the interface descriptor; return null
     ...
     * Return a simple boolean which is {@code true} if the operation succeeds; {{@code false} otherwise} when 
     ...
     * @param { MessageParcel } reply - Indicates the {@link MessageParcel} object receiving the response data.
     * @param { MessageOption } options - Indicates a synchronous (default) or asynchronous request.
     * @returns { Promise<SendRequestResult> } Returns the promise of the {@link SendRequestResult} instance.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     * @param { number } code - Indicates the message code called by the request, which is determined by the client and server.
     * If the method is generated by an IDL tool, the message code is automatically generated by the IDL tool.
     * @param { MessageSequence } data - Indicates the {@link MessageSequence} object storing the data to send.
     * @param { MessageSequence } reply - Indicates the {@link MessageSequence} object receiving the response data.
     * @param { MessageOption } options - Indicates a synchronous (default) or asynchronous request.
     * @returns { Promise<RequestResult> } Returns the promise of the {@link RequestResult} instance.
     * @throws { BusinessError } 401 - check param failed
     * @syscap SystemCapability.Communication.IPC.Core
  ...
  class RemoteProxy implements IRemoteObject {
     ...
     * @param { MessageParcel } reply - Indicates the {@link MessageParcel} object receiving the response data.
     * @param { MessageOption } options - Indicates a synchronous (default) or asynchronous request.
     * @returns { Promise<SendRequestResult> } Return the promise of the {@link sendRequestResult} instance.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     * @param { number } code -Indicates the message code called by the request, which is determined by the client and server.
     * If the method is generated by an IDL tool, the message code is automatically generated by the IDL tool.
     * @param { MessageSequence } data -Indicates the {@link MessageSequence} object storing the data to be sent.
     * @param { MessageSequence } reply -Indicates the {@link MessageSequence} object receiving the response data.
     * @param { MessageOption } options - Indicates a synchronous (default) or asynchronous request.
     * @returns { Promise<RequestResult> } Return the promise of the {@link RequestResult} instance.
     * @throws { BusinessError } 401 - check param failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
     */
  ...
  class IPCSkeleton {
     ...
     * @returns { number } Return {@code 0} if the operation succeeds; return an error code if the input object is empty
  ...
  class Ashmem {
     ...
     *
     * @param { string } name - Indicates the name of the Ashmem object to create.
     * @param { number } size - Indicates the size (in bytes) of the Ashmem object to create.
     ...
     *
     * @param { Ashmem } ashmem - Indicates the existing Ashmem object.
     * @returns { Ashmem } Return the ashmem object created.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     * @useinstead ohos.rpc.Ashmem#create
     ...
     *
     * @returns { number } Return the mapped memory size of this Ashmem object.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     */
     ...
     *
     * @param { number } mapType - Indicates the protection level of the memory region to which the shared file is mapped.
     * @returns { boolean } Return {@code true} if the operation is successful; return {@code false} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     *
     * @returns { boolean } Return {@code true} if the operation is successful; return {@code flase} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     *
     * @param { number } protectionType - Indicates the protection type to set.
     * @returns { boolean } Return {@code true} if the operation is successful; return {@code flase} otherwise.
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 8
     * @deprecated since 9
     ...
     *
     * @param { number[] } buf - Indicates the data to write.
     * @param { number } size - Indicates the size of the data to write.
     * @param { number } offset - Indicates the start position of the data to write in the memory region associated 
     ...
     *
     * @param { number } size - Indicates the size of the data to read.
     * @param { number } offset - Indicates the start position of the data to read in the memory region associated 
     *                   with this Ashmem object.
     ...
     * @param { number } offset - Indicates the start position of the data to read in the memory region associated 
     *                   with this Ashmem object.
     * @returns { number[] } Return the data read.
     * @throws { BusinessError } 401 - check param failed
     * @throws { BusinessError } 1900004 - read from ashmem failed
     * @syscap SystemCapability.Communication.IPC.Core
     * @since 9
