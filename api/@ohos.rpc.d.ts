 ...
 */
     ...
     * byteArray, short, shortArray, int, intArray, long, longArray, float, floatArray, double, doubleArray, boolean,
     * booleanArray, char, charArray, String, StringArray, {@link IRemoteObject}, IRemoteObjectArray,
     * {@link Parcelable}, and SequenceableArray.
     *
     * @since 9
     * @syscap SystemCapability.Communication.IPC.Core
     * @import import rpc from '@ohos.rpc'
    ...
    class MessageSequence {
         ...
         * @param object Remote object to serialize.
         * @throws {BusinessError} If verify param failed
         *                         or proxy or remote object is invalid
         *                         or write data to message parcel failed.
         * @since 9
         */
         ...
         * @return Returns the remote object.
         * @throws {BusinessError} If proxy or remote object is invalid
         *                         or read data from message parcel failed.
         * @since 9
         */
        readRemoteObject(): IRemoteObject;
         ...
         * @return Returns a string value.
         * @throws {BusinessError} If read data from message parcel failed.
         * @since 9
         */
        readInterfaceToken(): string;
         ...
         * @throws {BusinessError} If write data to message parcel failed.
         * @since 9
         */
        writeNoException(): void;
         ...
         * if {@link writeNoException} was invoked in server side.
         * @throws {BusinessError} If read message sequence fail.
         * @since 9
         */
        readException(): void;
         ...
         * @param val Indicates the short integer value to write.
         * @throws {BusinessError} If verify param failed
         *                         or write message sequence fail.
         * @since 9
         */
         ...
         * @since 9
         */
        writeSequenceable(val: SequenceableV9): void;
         ...
         * @param sequenceableArray Indicates the {@link Parcelable} object array to write.
         * @throws {BusinessError} If verify param failed
         *                         or write data to message parcel failed.
         * @since 9
         */
        writeSequenceableArray(sequenceableArray: SequenceableV9[]): void;
         ...
         * @throws {BusinessError} If verify param failed
         *                         or read data from message parcel failed
         *                         or call js callback function failed.
         * @since 9
         */
        readSequenceable(dataIn: SequenceableV9) : void;
         ...
         * @param sequenceableArray Parcelable array to read.
         * @throws {BusinessError} If verify param failed
         *                         or read data from message parcel failed
         *                         or call js callback function failed.
         * @since 9
         */
        readSequenceableArray(sequenceableArray: SequenceableV9[]): void;
         ...
         * @return A duplicated file descriptor.
         * @throws {BusinessError} If verify param failed
         *                         or call os dup function failed.
         * @since 9
         */
        static dupFileDescriptor(fd: number) :number;
    ...
    */
    ...
    class RemoteProxy implements IRemoteObject {
         ...
         * @return Returns null by default, indicating a proxy interface.
         * @throws {BusinessError} If verify param failed
         *                         or just remote object permitted.
         * @since 9
         */
         ...
         *
         * @return Returns the interface descriptor.
         * @throws {BusinessError} If communication failed
         *                         or proxy or remote object is invalid.
         * @since 9
         */
        getDescriptor(): string;
         ...
         * @since 9
         */
        sendRequest(code: number, data: MessageSequence, reply: MessageSequence, options: MessageOption, callback: AsyncCallback<RequestResult>): void;
    ...
    class Ashmem {
         ...
         * The size of the mapping region is specified by this Ashmem object.
         * @param mapType Protection level of the memory region to which the shared file is mapped.
         * @throws {BusinessError} If call mmap function failed.
         * @since 9
         */
         ...
         * Sets the protection level of the memory region to which the shared file is mapped.
         * @param protectionType Protection type to set.
         * @throws {BusinessError} if call os ioctl function failed over shared memory file descriptor.
         * @since 9
         */
