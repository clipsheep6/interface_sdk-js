...
declare namespace i18n {
  ...
  /**
   * Provides some functions for settings and oobe to select language or region.
   *
   * @syscap SystemCapability.Global.I18n
   * @systemapi Hide this for inner system use.
   * @since 10
  ...
  export class SystemLocaleManager {
     ...
     * @param { SortOptions } option - Specifies how to sort.
     * @returns { Array<LocaleItem> } Locale Information sorted by Requirements.
     * @throws { BusinessError } 401 - check param failed.
     * @throws { BusinessError } 890001 - param value not valid.
     * @syscap SystemCapability.Global.I18n
     * @systemapi Hide this for inner system use.
     * @since 10
     */
    getLanguageInfoArray(languages: Array<string>, option: SortOptions): Array<LocaleItem>;
     ...
     * @since 10
     */
    getCountryInfoArray(regions: Array<string>, option: SortOptions): Array<LocaleItem>;
  }
}
export default i18n;
