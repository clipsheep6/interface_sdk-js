...
declare namespace fileUri {
  ...
  class FileUri extends uri.URI {
     ...
     *
     * @permission SystemCapability.FileManagement.AppFileService
     * @param { uriOrPath } string  Uri or Path.
    ...
    /**
     * Obtains the file path of fileuri.
     *
     * @throws { BusinessError } 13900005 - I/O error
     * @throws { BusinessError } 13900042 - Unknown error
     * @throws { BusinessError } 14300002 - Invalid uri
    ...
    /**
     * Obtains the file name of fileuri.
     *
     * @throws { BusinessError } 13900005 - I/O error
     * @throws { BusinessError } 13900042 - Unknown error
     * @syscap SystemCapability.FileManagement.AppFileService
