...
declare namespace avSession {
   ...
   * @permission ohos.permission.MANAGE_MEDIA_RESOURCES
   * @param { 'sessionCreate' | 'sessionDestroy' | 'topSessionChange' } type - Registration Type
   ...
   * @permission ohos.permission.MANAGE_MEDIA_RESOURCES
   * @param { 'sessionCreate' | 'sessionDestroy' | 'topSessionChange' } type - Registration Type, session creation, deletion or top priority session change
  ...
  interface AVSession {
     ...
     * @param { 'play' | 'pause' | 'stop' | 'playNext' | 'playPrevious' | 'fastForward' | 'rewind' } type - Command to register.
