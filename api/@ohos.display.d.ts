...
declare namespace display {
  ...
  /**
   * Register the callback for capture status changes.
   *
   * @param { 'captureStatusChange' } type the status of capture changes
  ...
  /**
   * Unregister the callback for capture status changes.
   *
   * @param { 'captureStatusChange' } type the status of capture changes
   * @param { Callback<boolean> } callback Callback used to return the device capture status
   * @throws { BusinessError } 401 - Parameter error.
