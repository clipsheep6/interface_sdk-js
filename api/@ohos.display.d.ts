...
declare namespace display {
  ...
  /**
   * Register the callback for capture changes.
   *
   * @param { 'captureEvent' } type the event of capture changes
   * @param { Callback<boolean> } callback Callback used to return the current fold angle of device
   * @throws { BusinessError } 401 - Parameter error.
   * @throws { BusinessError } 801 - Capability not supported on this device.
   * @throws { BusinessError } 1400003 - This display manager service works abnormally.
   * @syscap SystemCapability.Window.SessionManager
   * @since 12
   */
  function on(type: 'captureEvent', callback: Callback<boolean>): void;

  /**
   * Unregister the callback for capture changes.
   *
   * @param { 'captureEvent' } type the event of capture changes
   * @param { Callback<boolean> } callback Callback used to return the current fold angle of device
   * @throws { BusinessError } 401 - Parameter error.
   ...
   * @since 12
   */
  function off(type: 'captureEvent', callback?: Callback<boolean>): void;
