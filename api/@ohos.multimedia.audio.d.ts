...
declare namespace audio {
  ...
  interface AudioVolumeGroupManager {
    ...
    /**
     * Get the max amplitude value for a specific output device. This method uses a promise to return the result.
    ...
    /**
     * Get the max amplitude value for a specific input device. This method uses a promise to return the result.
