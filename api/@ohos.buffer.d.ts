...
declare namespace buffer {
    ...
    /**
     * Allocate a new Buffer for a fixed size bytes. If fill is undefined, the Buffer will be zero-filled.
     * @since 9
     * @syscap SystemCapability.Utils.Lang
    ...
    /**
     * Allocate a new Buffer for a fixed size bytes. The Buffer will not be initially filled.
     * @since 9
     * @syscap SystemCapability.Utils.Lang
     * @param size The desired length of the new Buffer
     * @returns Return a new allocated Buffer
    ...
    /**
     * Allocate a new un-pooled Buffer for a fixed size bytes. The Buffer will not be initially filled.
     * @since 9
     * @syscap SystemCapability.Utils.Lang
     * @param size The desired length of the new Buffer
     * @returns Return a new allocated Buffer
    ...
    /**
     * Return the byte length of a string when encoded using `encoding`.
    ...
    /**
     * Return a new `Buffer` which is the result of concatenating all the `Buffer`instances in the `list` together.
     * @since 9
     * @syscap SystemCapability.Utils.Lang
    ...
    /**
     * Allocate a new Buffer using an array of bytes in the range 0 – 255. Array entries outside that range will be truncated to fit into it.
     * @since 9
     * @syscap SystemCapability.Utils.Lang
    ...
    /**
     * Return true if encoding is the name of a supported character encoding, or false otherwise.
     * @since 9
     * @syscap SystemCapability.Utils.Lang
     ...
     * @returns Return a new Buffer instance
     * @throws {BusinessError} 401 - if the input parameters are invalid.
     */
    /**
     * Re-encodes the given Buffer or Uint8Array instance from one character encoding to another.
	 ...
	 * @throws {BusinessError} 10200013 - Cannot set property byteOffset of Buffer which has only a getter
        ...
        /**
         * Return a new Buffer that references the same memory as the original, but offset and cropped by the start and end indices.
         * @since 9
         * @syscap SystemCapability.Utils.Lang
         * @param [start = 0] Where the new Buffer will start
         * @param [end = buf.length] Where the new Buffer will end (not inclusive)
         * @returns Return a new Buffer that references the same memory as the original
         */
        /**
         * Return a new Buffer that references the same memory as the original, but offset and cropped by the start and end indices.
         * @crossplatform
    ...
    class Blob {
        ...
        type: string;
         ...
         /**
         * Return a promise that fulfills with an <ArrayBuffer> containing a copy of the Blob data.
         * @since 9
         * @syscap SystemCapability.Utils.Lang 
         */
         /**
        ...
        slice(start?: number, end?: number, type?: string): Blob;
         ...
         /**
         * Return a promise that fulfills with the contents of the Blob decoded as a UTF-8 string.
         * @since 9
         * @syscap SystemCapability.Utils.Lang 
         */
         /**
