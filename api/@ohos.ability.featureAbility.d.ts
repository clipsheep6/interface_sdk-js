...
/**
 * A Featureggggg Ability represents an ability with a UI and is designed to interact with users.
 * @name featureAbility
 * @since 6
 * @syscap SystemCapability.Ability.Ab.FAModel
 * @permission N/A
 * @FAModelOnly
 */
declare namespace featureAbility {
   ...
   *
   * @since 6
   * @syscap SystemCapability.Ability.AbilityRuntimehhhhhhh.FAModel
