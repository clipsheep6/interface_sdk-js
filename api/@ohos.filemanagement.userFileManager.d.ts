...
declare namespace userFileManager {
  ...
  interface UserFileManager {
     ...
     *
     * @permission ohos.permission.WRITE_IMAGEVIDEO
     * @param { Array<FileAsset> } assets - Assets to set hidden state
     ...
     * @since 11
     */
    setHidden(assets: Array<FileAsset>, hiddenState: boolean, callback: AsyncCallback<void>): void;
    /**
     * Set assets hidden state.
     *
     * @permission ohos.permission.WRITE_IMAGEVIDEO
     ...
     * @since 11
     */
    setHidden(assets: Array<FileAsset>, hiddenState: boolean): Promise<void>;
    /**
