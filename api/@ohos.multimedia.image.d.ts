...
function createPixelMapSync(options: InitializationOptions): PixelMap;
  ...
  /**
   * Transforms pixelmap from nonpremultiplied alpha format to premultiplied alpha format.
   *
   ...
   * @since 12
   */
function createPremultiplyPixelMap(src: PixelMap, dst: PixelMap, callback: AsyncCallback<void>): void;
...
function createUnPremultiplyPixelMap(src: PixelMap, dst: PixelMap): Promise<void>;
   ...
   * @since 12
   */
function createUnPremultiplyPixelMap(src: PixelMap, dst: PixelMap, callback: AsyncCallback<void>): void;
