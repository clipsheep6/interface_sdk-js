...
declare namespace bundleManager {
  ...
  /**
   * Add appid list of bundles that can't be uninstalled in the device.
   * Only apps with the ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { Array<string> } appIds - ids of the bundle that can't be uninstalled.
   * @param { AsyncCallback<void> } callback - the callback of addDisallowedUnintallBundles.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 201 - the application does not have permission to call this function.
   * @throws { BusinessError } 202 - not system application.
   ...
   * @since 10
   */
  function addDisallowedUnintallBundles(admin: Want, appIds: Array<string>, callback: AsyncCallback<void>): void;
   ...
   * @since 10
   */
  function addDisallowedUnintallBundles(admin: Want, appIds: Array<string>, userId: number, callback: AsyncCallback<void>): void;
   ...
   * @param { Array<string> } appIds - ids of the bundle that can't be uninstalled.
   * @param { number } [userId] - userId indicates the user ID or do not pass user ID.
   * @returns { Promise<void> } the promise returned by the addDisallowedUnintallBundles.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 201 - the application does not have permission to call this function.
   * @throws { BusinessError } 202 - not system application.
   ...
   * @since 10
   */
  function addDisallowedUnintallBundles(admin: Want, appIds: Array<string>, userId?: number): Promise<void>;

  /**
   * Remove appid list of bundles that can't be uninstalled in the device.
   * Only apps with the ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { Array<string> } appIds - ids of the bundle that can't be uninstalled.
   * @param { AsyncCallback<void> } callback - the callback of removeDisallowedUnintallBundles.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 201 - the application does not have permission to call this function.
   * @throws { BusinessError } 202 - not system application.
   ...
   * @since 10
   */
  function removeDisallowedUnintallBundles(admin: Want, appIds: Array<string>, callback: AsyncCallback<void>): void;
   ...
   * @since 10
   */
  function removeDisallowedUnintallBundles(admin: Want, appIds: Array<string>, userId: number, callback: AsyncCallback<void>): void;
   ...
   * @param { Array<string> } appIds - ids of the bundle that can't be uninstalled.
   * @param { number } [userId] - userId indicates the user ID or do not pass user ID.
   * @returns { Promise<void> } the promise returned by the removeDisallowedUnintallBundles.
   * @throws { BusinessError } 9200003 - the administrator ability component is invalid.
   * @throws { BusinessError } 9200007 - the system ability work abnormally.
   * @throws { BusinessError } 201 - the application does not have permission to call this function.
   * @throws { BusinessError } 202 - not system application.
   ...
   * @since 10
   */
  function removeDisallowedUnintallBundles(admin: Want, appIds: Array<string>, userId?: number): Promise<void>;


  /**
   * Get the appid list of bundles that can't be uninstalled in the device.
   * Only apps with the ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { AsyncCallback<Array<string>> } callback - the callback that contains the appid list.
   ...
   * @since 10
   */
  function getDisallowedUnintallBundles(admin: Want, callback: AsyncCallback<Array<string>>): void;
   ...
   * @since 10
   */
  function getDisallowedUnintallBundles(admin: Want, userId: number, callback: AsyncCallback<Array<string>>): void;

  /**
   * Get appid list of bundles that can't be uninstalled in the device.
   * Only apps with the ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY permission can call this method.
   * @permission ohos.permission.ENTERPRISE_SET_BUNDLE_INSTALL_POLICY
   * @param { Want } admin - admin indicates the administrator ability information.
   * @param { number } [userId] - userId indicates the user ID or do not pass user ID.
   ...
   * @since 10
   */
  function getDisallowedUnintallBundles(admin: Want, userId?: number): Promise<Array<string>>;
}
