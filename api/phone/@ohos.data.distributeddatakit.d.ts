...
import { KVStore } from "./data/distributeddatakit/kvstore";
import { Options } from "./data/distributeddatakit/plain_ordinary_js_objects";
import { KVManagerConfig } from './data/distributeddatakit/kvmanager_config'

declare namespace distributedDataKit {
    /**
...
export default distributedDataKit;