 ...
 */
  ...
  */
   ...
   * @return Returns string in json-format of the corresponding config file.
   */
  function getProfileByExAbility(moduleName: string, extensionAbilityName: string, metadataName: string, callback: AsyncCallback<Array<string>>): void;
  function getProfileByExAbility(moduleName: string, extensionAbilityName: string, metadataName?: string): Promise<Array<string>>;
}
