...
declare namespace queue {
  class Queue<T> {
    ...
    length: number;
    /**
     * Inserting specified element at the end of a queue if it is possible to do so immediately without
     ...
     * @param callbackfn (required) A function that accepts up to four arguments.The function to be called for each element in the queue
