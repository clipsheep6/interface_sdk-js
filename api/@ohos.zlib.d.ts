...
declare namespace zlib {
  ...
  /**
   * Defines InflateBack Input Callback.
   * @typedef InflateBackInputCallback
   * @syscap SystemCapability.BundleManager.Zlib
   * @atomicservice
   * @since 12
   */
  interface InflateBackInputCallback {
    /**
  ...
  /**
   * Defines InflateBack Output Callback.
   * @typedef InflateBackInputCallback
   * @syscap SystemCapability.BundleManager.Zlib
   * @atomicservice
   * @since 12
   */
  interface InflateBackOutputCallback {
    /**
     * A function that decompresses data from the end to read the raw compressed data from the input source.
     * @param { object } outDesc
     ...
     * @since 12
     */
    (outDesc: object, buf: ArrayBuffer, length: number): number;
  }
   ...
   * @param { string } outFile - Indicates the path of the output compressed file.
   * @param { Options } outFile - Indicates the options of compressing file.
   * @returns { Promise<void> } Returns the result of compressFile file.
   * @throws { BusinessError } 401 - The parameter check failed.
   * @throws { BusinessError } 900001 - The input source file is invalid.
   * @throws { BusinessError } 900002 - The input destination file is invalid.
  ...
  interface Zip {
     ...
     * @throws { BusinessError } 401 - Invalid argument.
     * @throws { BusinessError } 17800003 - System error.
     ...
     * @since 12
     */
    compress2(dest: ArrayBuffer, source: ArrayBuffer, level: CompressLevel): Promise<ZipOutputInfo>;
     ...
     *
     * @param { ZStream } strm - Object to structure z_stream.
     * @param { number } bits - The provided bits, bits must be less than or equal to 16.
     ...
     * windowBits must be greater than or equal to the windowBits value provided to deflateInit2() while compressing, or it must be equal to 15 if deflateInit2() was not used.
     * If a compressed stream with a larger window size is given as input, inflate() will return with the error code Z_DATA_ERROR instead of trying to allocate a larger window.
     * WindowBits can also be zero to request that inflate use the window size in the zlib header of the compressed stream.
     * WindowBits can also be -8..-15 for raw inflate. In this case, -windowBits determines the window size. inflate() will then process raw deflate data,
     * not looking for a zlib or gzip header, not generating a check value, and not looking for any check values for comparison at the end of the stream.
     ...
     * a CRC-32 be applied to the uncompressed data as is done in the zlib, gzip, and zip formats. For most applications, the zlib format should be used as is.
     * Note that comments above on the use in deflateInit2() applies to the magnitude of windowBits.
     * WindowBits can also be greater than 15 for optional gzip decoding. Add 32 to windowBits to enable zlib and gzip decoding with automatic header detection,
     * or add 16 to decode only the gzip format. If a gzip stream is being decoded, strm->adler is a CRC-32 instead of an Adler-32. Unlike the gunzip utility and gzread(),
     * inflate() will *not* automatically decode concatenated gzip members. inflate() will return Z_STREAM_END at the end of the gzip member.
     * The state would need to be reset to continue decoding a subsequent gzip member. This *must* be done if there is more data after a gzip member,
     * in order for the decompression to be compliant with the gzip standard.
     * @returns { Promise<ReturnStatus> } Return ReturnStatus the specific meaning is defined as enum.
     * @throws { BusinessError } 401 - Invalid argument.
     * @throws { BusinessError } 17800003 - System error.
     * @throws { BusinessError } 17800004 - ZStream error.
     ...
     * @throws { BusinessError } 17800006 - Memory allocation failed.
     * @throws { BusinessError } 17800007 - Buffer error.
     * @throws { BusinessError } 17800008 - Version error.
     * @syscap SystemCapability.BundleManager.Zlib
     * @atomicservice
     * @since 12
     */
     ...
     * @param { ZStream } strm - Object to structure z_stream.
     * @param { CompressLevel } level - Compression level.
     * @param { number } method - The compression method.
     * @param { number } windowBits - Parameter is interpreted the same as it is for inflateInit2.
     ...
     * @since 12
     */
    deflateInit2(strm: ZStream, level: CompressLevel, method: number, windowBits: number, memLevel: MemLevel, strategy: CompressStrategy): Promise<ReturnStatus>;
  ...
  interface GZip {
     ...
     * @returns { Promise<GzFile> } Successfully returned object of GzFile type.
     * @throws { BusinessError } 401 - Invalid argument.
     ...
     * @since 12
     */
    gzclose(file: GzFile): Promise<ReturnStatus>;
     ...
     * @since 12
     */
    gzerror(file: GzFile): Promise<GzErrorOutputInfo>;

    /**
     * Read and decompress one byte from file.
     *
     * @param { GzFile } file - GzFile type object.
     * @returns { Promise<number> } Return ASCII character.
     * @throws { BusinessError } 401 - Invalid argument.
     * @throws { BusinessError } 17800009 - Internal structure error.
     * @syscap SystemCapability.BundleManager.Zlib
     * @atomicservice
     ...
     * @returns { Promise<ReturnStatus> } The return value is the zlib error number.
     * @throws { BusinessError } 401 - Invalid argument.
     * @throws { BusinessError } 17800009 - Internal structure error.
     * @syscap SystemCapability.BundleManager.Zlib
     * @atomicservice
     * @since 12
     */
    gzflush(file: GzFile, flush: CompressFlushMode): Promise<ReturnStatus>;
     ...
     * @since 12
     */
    gzwrite(file: GzFile, buf: ArrayBuffer): Promise<number>;
     ...
     * @since 12
     */
    gzsetparams(file: GzFile, level: CompressLevel, strategy: CompressStrategy): Promise<ReturnStatus>;
     ...
     *
     * @param { GzFile } file - GzFile type object.
     * @returns { Promise<ReturnStatus> } returns the resulting offset location as measured in bytes from the beginning of the uncompressed stream.
     * @throws { BusinessError } 401 - Invalid argument.
     * @throws { BusinessError } 17800009 - Internal structure error.
     * @syscap SystemCapability.BundleManager.Zlib
     * @atomicservice
     * @since 12
     */
    gzrewind(file: GzFile): Promise<ReturnStatus>;
     ...
     * @since 12
     */
    gzread(file: GzFile, buf: ArrayBuffer): Promise<number>;
     ...
     *
     * @param { GzFile } file - GzFile type object.
     * @param { number } char - Write character ASCII.
     ...
     * @since 12
     */
    gzputc(file: GzFile, char: number): Promise<number>;
     ...
     * @since 12
     */
    gzoffset(file: GzFile): Promise<number>;
     ...
     *
     * @param { GzFile } file - GzFile type object.
     * @param { string } buf - Store the read row data.
     * @param { number } len - The size of the buffer, how many characters can be read at most.
     ...
     * @since 12
     */
    gzgets(file: GzFile, buf: string, len: number): Promise<string>;
  }
}
export default zlib;
