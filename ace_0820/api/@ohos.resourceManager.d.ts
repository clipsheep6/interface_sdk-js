...
/**
 * Obtains the ResourceManager object of the specified android application.
 *
 * @param bundleName Indicates the bundle name of the specified application.
 * @param callback Indicates the callback containing the ResourceManager object.
 * @since 7
 */
export function getAResourceManager(bundleName: string, callback: AsyncCallback<ResourceManager>);
 ...
 * @since 7
 */
export function getAResourceManager(bundleName: string): Promise<ResourceManager>;
