...
declare namespace hiAppEvent {
    /**
     * Enumerates application event types.
     */
    enum EventType {
      /**
       * Fault event
    ...
    /**
     * application event dotting configuration interface.
     *
     * @static
     * @param {ConfigOption} config application dotting configuration item object.
    ...
    interface ConfigOption {
      /**
       * configuration item: application event dotting switch.
       */
      disable?: boolean;
