 ...
 *
 * @param { string } name
 * @param { CreateAccountOptions } options
...
declare function createAccount(name: string): void;
 ...
 */
declare function createAccount(name: string): void;
declare function createAccount(name: string, age: number, sex: string, options?: CreateAccountOptions): Promise<void>;
 ...
 */
declare function createAccount(name: string): void;
declare function createAccount(callback: AsyncCallback<void>): void;
 ...
 * @since 7
 */
declare function createAccount(name: string, age: number, options?: CreateAccountOptions): Promise<void>;

/**
 * Obtain the default display.
 *
 * @param { CallbAsyncCallbackack<void> } callback
 * @syscap SystemCapability.ArkUI.ArkUI.Full
 * @since 7
 */
declare function getAll(callback: AsyncCallback<Display>): void;

declare function createAccount(name: string, age: number, sex: string, options?: CreateAccountOptions): void;
