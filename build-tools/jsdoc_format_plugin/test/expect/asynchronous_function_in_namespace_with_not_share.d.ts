...
declare namespace MediaQueryEvent {
   ...
   */
  function createAccount(name: string): void;
  function createAccount(name: string, age: number, sex: string, options?: CreateAccountOptions): Promise<void>;
   ...
   */
  function createAccount(name: string): void;
  function createAccount(callback: AsyncCallback<void>): void;
   ...
   * @since 7
   */
  function createAccount(name: string, age: number, options?: CreateAccountOptions): Promise<void>;
  ...
  function createAccount(name: string, age: number, sex: string, options?: CreateAccountOptions): void;
}
