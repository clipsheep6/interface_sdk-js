...
import { AsyncCallback, Callback } from './basic';
  ...
  export class MediaQueryEvent {
     ...
     */
    createAccount(name: string): void;
    createAccount(name: string, age: number, sex: string, options?: CreateAccountOptions): Promise<void>;
     ...
     */
    createAccount(name: string): void;
    createAccount(callback: AsyncCallback<void>): void;
     ...
     * @since 7
     */
    createAccount(name: string, age: number, options?: CreateAccountOptions): Promise<void>;
     ...
     * @since 7
     */
    getAll(callback: AsyncCallback<Display>): void;

    createAccount(name: string, age: number, sex: string, options?: CreateAccountOptions): void;
  }
