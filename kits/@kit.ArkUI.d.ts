...
import { InterstitialDialogAction, IconStyle, TitlePosition } from '@ohos.atomicservice.InterstitialDialogAction';
import {
...
export {
  ...
  InterstitialDialogAction, IconStyle, TitlePosition
};
