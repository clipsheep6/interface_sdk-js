...
import { AtomicServiceTabs, TabBarOption, TabBarPosition, TabContentBuilder } form '@ohos.atomicservice.AtomicServiceTabs';
...
export {
  ...
  AtomicServiceTabs, TabBarOption, TabBarPosition, TabContentBuilder
};
